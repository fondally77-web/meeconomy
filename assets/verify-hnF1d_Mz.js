import{i as u,s as m,j as h,g as f}from"./scoring-DPCV9KzM.js";const g=["4月","5月","6月","7月","8月","9月","10月","11月","12月","1月","2月","3月"];function v(s){const e=s.month;return e>=3&&e<=5?{lambsToBuy:3,sheepToShear:6,sheepToShip:3,slaughterQty:6,meatDirectRatio:.3,spinQty:0,yarnDirectRatio:0,meatRecipes:{genghis:3,lambCurry:1},apparelRecipes:{},priceStance:"standard",truckAssignment:{"farm-meat":1,"farm-wool":0,"meat-delica":1,"meat-sales":0,"delica-sales":1,"wool-apparel":0,"apparel-sales":0}}:{lambsToBuy:2,sheepToShear:6,sheepToShip:0,slaughterQty:0,meatDirectRatio:0,spinQty:8,yarnDirectRatio:.1,meatRecipes:{},apparelRecipes:e>=6?{sweater:2,muffler:2}:{muffler:3},priceStance:"standard",truckAssignment:{"farm-meat":0,"farm-wool":1,"meat-delica":0,"meat-sales":0,"delica-sales":0,"wool-apparel":1,"apparel-sales":1}}}function b(s){let e=u(s);const n=[];for(let i=0;i<12&&!e.bankrupt;i++){const d=v(e),{next:t,result:a}=m(e,d);if(e=t,e.puzzle){const o=e.puzzle.answerRowId;h(e.puzzle,o)&&(e.gapsFound++,e.cash+=1500)}n.push({monthLabel:g[a.month],result:a})}return{seed:s,steps:n,finalState:e,score:f(e,s)}}const l=document.querySelector("#app");if(!l)throw new Error("Missing #app");const $=l,r=s=>`${Math.round(s).toLocaleString("ja-JP")}G`,w=s=>s==="none"?"通常月":s;function c(s){const e=b(s),n=Math.max(1,...e.steps.map(t=>Math.abs(t.result.consolidatedProfit))),i=e.steps.reduce((t,a)=>a.result.consolidatedProfit>t.result.consolidatedProfit?a:t,e.steps[0]),d=e.steps.reduce((t,a)=>a.result.consolidatedProfit<t.result.consolidatedProfit?a:t,e.steps[0]);$.innerHTML=`
    <main class="shell">
      <section class="hero">
        <div>
