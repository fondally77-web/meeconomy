...
- **S02 パイプライン画面＝マップがメニュー**：二股レイアウト（上段ウール・下段肉）、P0デモのドット絵羊・トラック・合成SEを移植
- **指示フェーズ**：**羊を直接タップで毛刈り（✂️ポンッ・もう一度で取消）**、**建物タップで各社の指示窓**（ミート=と畜、デリカ=レシピ、ロジ=配車＋自動配分…）。指示済みの会社には✓、配車したトラックは道路に停車して見える
