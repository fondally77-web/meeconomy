...
- **毎月が「お仕事体験」の工程で進む**：
  1. 🐑ファーム：**✂️/🔪の道具を選んで羊を直接タップ**（刈ると毛袋がポンと山に積まれ、出荷すると羊が乗り場へ歩いていく）＋子羊購入
  2. 🚚集荷：トラックが自分の毛袋・羊を実際に積んで運ぶ（台数不足なら積み残しが見える＝L5の学び）
  3. 🧶🥩しこみ：タップで紡績・と畜（目の前で羊毛→糸、羊→ラム肉に変わる）＋直販の取り分け
  4. 🚚配達 → 👕🍖加工：レシピをタップして1つずつ生産
  5. 🚚出荷 → 🏪開店：値付け3択→開店！売上がコインで飛ぶ→月末リザルト
